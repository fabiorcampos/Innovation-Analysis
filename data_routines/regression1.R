...
### Selecionar duas variáveis e plotar(plot(dep ~ ind, dbase))
p <- plot(disp ~ hp, mtcars)

### Calcular regressão
fit <- lm(disp ~ hp, galton) ### seleciona LM e coloque as variáveis dep e ind e o DB galton

### summarizar a regressão
summary(fit)

### plotar uma abline contendo a regressão
