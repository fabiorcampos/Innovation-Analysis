...
CS <- conceptualStructure(database, field="ID", minDegree=4, k.max=5, stemming=FALSE)
...
##Scopus analysis
Dtscop <- readFiles("C:/Users/Biota/Desktop/analises_innovation/scopus.bib") ##readbibtex scopus
databasescop <- convert2df(Dtscop, dbsource = "scopus", format = "bibtex")
resultsscop <- biblioAnalysis(databasescop, sep = ";")
S=summary(object = resultsscop, k = 10, pause = FALSE)
plot(x = resultsscop, k = 10, pause = FALSE)
